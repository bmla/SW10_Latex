...
We will therefore use accuracy as more precise measure of a techniques success.
...
While \swipe and \throw do not share any of the attributes we assigned them, they do have one thing in common: the cursor hand is held still through out the activation process.
...
The techniques are more accurate because the cursor is held still in the desired location
They are also more efficient since users feel more comfortable and confident with the techniques that allow for a stable cursor.
