...
\begin{table}[H]
	...
	\begin{tabular}{c c c c c}
		...
		\parbox[t]{2mm}{\multirow{2}{*}{\rotatebox[origin=c]{90}{\textbf{Number}}}} 
		\parbox[t]{2mm}{\multirow{2}{*}{\rotatebox[origin=c]{90}{\textbf{\ul{of Hands}}}}}
		& & \textbf{One handed} & Tilt & Swipe \\ \cline{3-5}
		& & \textbf{Two handed} & Throw & Grab \\ \cline{3-5}
	\end{tabular}
