...
For the \target 27\% of the participants started the test with \pinch, 21\% with \swipe, 25\% with \throw, and 27\% with \tilt.
Similarly, for the \accuracy 22\% of the participants started the test with \pinch, 27\% with \swipe, 24\% with \throw, and 27\% with \tilt.
