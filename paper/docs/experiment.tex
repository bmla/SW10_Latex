...
\begin{figure}[H]
	...
	\subfloat[]{\includegraphics[width = 1\columnwidth]{images/accuracy.pdf}\label{fig:accuracy}}
	\end{minipage}%
	\hspace{0.01\columnwidth}
	\begin{minipage}[c]{.88\columnwidth}
	\centering
	\subfloat[\push]{\includegraphics[width = 0.48\columnwidth]{images/pushScreen.pdf}\label{fig:pushScreen}}
	\hspace{0.01\columnwidth}
	\subfloat[\pull]{\includegraphics[width = 0.48\columnwidth]{images/pullScreen.pdf}\label{fig:pullScreen}}
	\end{minipage}
	\caption{\protect\subref{fig:target} The targets in the first part of the experiment. \protect\subref{fig:accuracy} The targets in the second part of the experiment. \protect\subref{fig:pushScreen} and \protect\subref{fig:pullScreen} show the screens on both the large display and the phone for the \accuracy.}
\end{figure}
