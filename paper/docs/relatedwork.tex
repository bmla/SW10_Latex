...
\todo[inline]{Note: This section still need to be arranged in a logical order. Some paragraphs are (most likely) not in the correct position now.}
...
\todo[inline]{Mention the \emph{Put-That-There} paper from 84 using voice and gestures.}

In the literature, research on different approaches to pointing and controlling e.g virtual pointers on a screen \todo{using these technologies? does what? not sure what this sentence is aimed at.} has been done by Mayer et al. and Vogel et al. among others.
