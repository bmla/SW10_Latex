...
In the literature, research on different approaches to pointing and controlling e.g virtual pointers on a screen \todo{using these technologies? does what? not sure what this sentence is aimed at.} has been done by Mayer et al. \cite{Mayer:2015} and Vogel et al. \cite{Vogel:2005} among others.
