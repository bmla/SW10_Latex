...
\begin{figure}[H]
	\subfloat[]{\includegraphics[width = 0.33\columnwidth]{images/techniques/grabPush1.jpg}\label{fig:grabTechniqueA}}
	\subfloat[]{\includegraphics[width = 0.33\columnwidth]{images/techniques/grabPush2.jpg}\label{fig:grabTechniqueB}}
	\subfloat[]{\includegraphics[width = 0.33\columnwidth]{images/techniques/grabPush3.jpg}\label{fig:grabTechniqueC}}
...
\begin{figure}[H]
	\subfloat[]{\includegraphics[width = 0.33\columnwidth]{images/techniques/swipePush1.jpg}\label{fig:swipeTechniqueA}}
	\subfloat[]{\includegraphics[width = 0.33\columnwidth]{images/techniques/swipePush2.jpg}\label{fig:swipeTechniqueB}}
	\subfloat[]{\includegraphics[width = 0.33\columnwidth]{images/techniques/swipePush3.jpg}\label{fig:swipeTechniqueC}}
...
\begin{figure}[H]
	\subfloat[]{\includegraphics[width = 0.33\columnwidth]{images/techniques/throwPush1.jpg}\label{fig:throwTechniqueA}}
	\subfloat[]{\includegraphics[width = 0.33\columnwidth]{images/techniques/throwPush2.jpg}\label{fig:throwTechniqueB}}
	\subfloat[]{\includegraphics[width = 0.33\columnwidth]{images/techniques/throwPush3.jpg}\label{fig:throwTechniqueC}}
...
\begin{figure}[H]
	\subfloat[]{\includegraphics[width = 0.33\columnwidth]{images/techniques/tiltPush1.jpg}\label{fig:tiltTechniqueA}}
	\subfloat[]{\includegraphics[width = 0.33\columnwidth]{images/techniques/tiltPush2.jpg}\label{fig:tiltTechniqueB}}
	\subfloat[]{\includegraphics[width = 0.33\columnwidth]{images/techniques/tiltPush3.jpg}\label{fig:tiltTechniqueC}}
...
\todo[inline]{something here for the next paragraph? no note, just an asterix}
