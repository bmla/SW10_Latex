...
The first is a pointing technique were the user uses his hands as a cursor on the screen \todo{add reference}.
The second is a technique used by Walter et al. \todo{add reference} in a system used to submit information onto a large public display.
...
The \tilt technique (\cref{fig:tiltTechnique}) is used by Lucero et al. in \todo{add reference}.
