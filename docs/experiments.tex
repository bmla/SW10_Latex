...
For this semester's studies the system will detect the height from the floor to the head joint and use this in the mapping between a participant's pointing hand and the cursor on the screen.
