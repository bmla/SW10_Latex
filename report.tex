...
%\includepdf[fitpaper,pages=-,pagecommand={\thispagestyle{empty}}]{posterv2.pdf} % The first page
\cleardoublepage
...
\includepdf[pages=-,pagecommand={\thispagestyle{customplain}}]{appendix/appendix.pdf}

\newpage\null\thispagestyle{empty}\newpage
\cleardoublepage

%\includepdf[pages=-,pagecommand={\thispagestyle{empty}}]{poster_page_back.pdf} % The last page
